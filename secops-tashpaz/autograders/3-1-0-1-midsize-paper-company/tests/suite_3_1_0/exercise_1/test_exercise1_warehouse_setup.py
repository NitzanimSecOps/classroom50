...
from solutions.suite_3_1_0.exercise_1.warehouse import Warehouse
...
class TestWarehouseSetup(unittest.TestCase):
    ...
    def test_init_creates_directories_with_string(self):
        ws = WarehouseSetup(str(self.root_path))
        self.assertTrue(self.root_path.exists(), "Root directory was not created when passed as a string")
